...
<html lang="en">
	<head>
      ...
      .dropdown-menu .comp-submenu {
        position: relative;
      }
      
      .dropdown-menu .comp-submenu > a:after {
  display: block;
  content: " ";
  float: right;
  width: 0;
...
.dropdown-menu .comp-submenu:hover > a:after {
  transform: rotate(90deg);
      ...
      .dropdown-menu .comp-submenu:hover .submenu {
        display: block;
      }
      ...
      .cabinet-dropdown:hover .login-form {
        opacity: 1;
        visibility: visible;
...
.login-form-title-bold-dotted::after {
  content: "";
  position: absolute;
  left: 0;
  bottom: 0;
